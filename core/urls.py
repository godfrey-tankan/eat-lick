...
urlpatterns = [
    ...
    path("surveys/", include("a_home.urls")),
    ...
    path(
        "get/support-members/",
        support_member_suggestions,
        name="support_member_suggestions",
    ),
    # PDF REPORTS
    path(
        "generate_support_member_report/",
        generate_support_member_report,
        name="generate_support_member_report",
    ),
    path(
        "generate_branch_report/", generate_branch_report, name="generate_branch_report"
    ),
    path(
        "generate_weekly_report/", generate_weekly_report, name="generate_weekly_report"
    ),
    path(
        "generate_overall_report/",
        generate_overall_report,
        name="generate_overall_report",
    ),
    path(
    ...
    path(
        "reports/support_member/",
        support_member_report_view,
        name="support_member_report",
    ),
...
urlpatterns += [
    ...
    path(
        "support-members/create/", create_support_member, name="create_support_member"
    ),
    path(
        "ticket-logs/", TicketLogListCreateView.as_view(), name="ticketlog-list-create"
    ),
    path(
        "ticket-logs/<int:pk>/", TicketLogDetailView.as_view(), name="ticketlog-detail"
    ),
    ...
    path(
        "ticket/<int:ticket_id>/fetch-messages/", fetch_messages, name="fetch_messages"
    ),
    ...
    path(
        "tickets/status/<str:status>/",
        ticket_list_by_status,
        name="ticket_list_by_status",
    ),
    path(
        "tickets/assigned-to/<int:member_id>/",
        support_member_tickets,
