...
CSRF_TRUSTED_ORIGINS = ['https://empyreanintegratedsolutions.com/','http://localhost:8000', 'http://localhost:5085', 'http://127.0.0.1:8000', 'https://tithehurst.co.zw/','https://empyreanintegratedsolutions.com/']
